    ...
    <section class="container-fluid bg-light pb-md-5">
      <div class="container pt-3 pb-5">
        ...
        <div class="row align-items-start mt-5 pb-5">
          ...
          >
            <img alt class="rounded-0 img-half" :src="randomProduct.imageUrl" />
            <div class="d-flex align-items-center mb-5 w-50 px-0 pt-3" v-if="randomProduct.title">
          ...
          <div class="col-md-4">
            <div class>
              <div class="d-flex align-items-center mb-3 my-md-5">
              ...
              <div class="p-md-5 offset-left border grid-background">
                <img class="img-fluid d-flex d-md-none" :src="randomProduct.imageUrl" alt />
                ...
                <p v-if="randomProduct.content">{{ellipsisContent}}</p>
