<template>
  <div id="carouselControls" class="carousel slide banner" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item carousel-item-min-height active">
        <div class="carousel-caption">
          <h1 class="display-2 text-white font-weight-bold text-left">華語流行榜</h1>
          <p class="text-muted mt-2 text-left">本周最新華語單曲，嚴選百首最新熱門單曲免費聽。</p>
          <div class="row">
    ...
    <a class="carousel-control-next" href="#carouselControls" role="button" data-slide="next">
      <span class="carousel-control-icon rotate" aria-hidden="true"></span>
